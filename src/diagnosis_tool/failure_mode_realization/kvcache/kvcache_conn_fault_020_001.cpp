...
bool KvcacheConnFault020_001::IsValid()
{
    ...
    std::string grepOutput = kvcache_log_helper::RunCommand(
        "test -n \"$WITTY_UB_CLIENT_ACCESS_LOG$WITTY_UB_WORKER_ACCESS_LOG\" && grep -E '\\[TCP_CONNECT_FAILED\\]' $WITTY_UB_CLIENT_INFO_LOG $WITTY_UB_WORKER_INFO_LOG 2>/dev/null | tail -20");
