...
bool KvcacheConnFault020_002::IsValid()
{
    ...
    std::string grepOutput = kvcache_log_helper::RunCommand(
        "test -n \"$WITTY_UB_CLIENT_ACCESS_LOG\" && grep -E '\\[TCP_CONNECT_RESET\\]|\\[TCP_NETWORK_UNREACHABLE\\]' $WITTY_UB_CLIENT_INFO_LOG $WITTY_UB_WORKER_INFO_LOG 2>/dev/null | tail -20");
