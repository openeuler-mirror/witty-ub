...
bool KvcacheConnFault020_010::IsValid()
{
    ...
    std::string grepOutput = kvcache_log_helper::RunCommand(
        "test -n \"$WITTY_UB_CLIENT_ACCESS_LOG\" && grep -E '\\[SOCK_CONN_WAIT_TIMEOUT\\]|\\[REMOTE_SERVICE_WAIT_TIMEOUT\\]' $WITTY_UB_CLIENT_INFO_LOG $WITTY_UB_WORKER_INFO_LOG 2>/dev/null | tail -20");
