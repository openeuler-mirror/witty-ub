...
bool KvcacheConnFault002_001::IsValid()
{
    ...
    std::string grepOutput = kvcache_log_helper::RunCommand(
        "test -n \"$WITTY_UB_CLIENT_ACCESS_LOG$WITTY_UB_WORKER_ACCESS_LOG\" && grep -E 'DS_KV_CLIENT_(PUT|GET)' $WITTY_UB_CLIENT_ACCESS_LOG $WITTY_UB_WORKER_ACCESS_LOG | grep -E 'The objectKey is empty|dataSize should be bigger than zero|length not match'");
