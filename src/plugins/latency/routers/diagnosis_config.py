...
async def get_diagnosis_config(kb_id: str) -> ResponseBase:
    ...
    return ResponseBase(result=await DiagnosisConfigManager.get_or_create(kb_id))
...
async def update_diagnosis_config(
    ...
    return ResponseBase(result=await DiagnosisConfigManager.upsert(kb_id, req))
...
async def reset_diagnosis_config(kb_id: str) -> ResponseBase:
    ...
    return ResponseBase(result=await DiagnosisConfigManager.reset(kb_id))
